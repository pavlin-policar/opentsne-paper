...
\caption{\label{tab:features}
  We compare the features of \opentsne~(v0.7.1) to \pkg{scikit-learn}~(v1.0.1),
...
\pkg{openTSNE}~v0.7.1 package. All results and figures can be reproduced using
