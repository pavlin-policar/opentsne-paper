...
\item multiscale similarity kernels~\cite{kobak2019art} which preserves small,
	well-defined clusters and uncovers global relationships between clusters,
	and
\item improved defaults for learning rate and the number of
...
\end{figure*}
or instance, in Fig.~\ref{fig:tasic}, we show four embeddings of
