...
install \opentsne\ through the Python Package Index (\textsf{PyPI}) or \textsf{conda} on the
\textsf{conda-forge} channel. \opentsne\ interface follows that of \textsf{scikit-learn},
