...
capable of producing informative data visualizations. Popular approaches include
...
developed FIt-SNE, an efficient approximation scheme that massively improves
...
update rule~\citep{jacobs1988increased}. The t-SNE optimization procedure
...
Embeddings produced by standard t-SNE often make use of all available space and
...
methods, such as UMAP and ForceAtlas2, produce embeddings where clusters appear
more compact and the white space separating the clusters may be interpreted as a
...
optimization, t-SNE introduces more white space between clusters which better
...
subgroups representing different cell subpopulations that are not visible under
